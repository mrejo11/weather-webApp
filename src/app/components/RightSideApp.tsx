  ...
  return (
    <>
      ...
      <div className="relative">
        <div className="absolute  mb-3 translate-y-[800px]  -translate-x-4 flex items-center justify-center xl:h-full  xl:left-[60vh] xl:w-[600px] xl:top-52 xl:translate-y-0 ">
