...
export default function RightSideApp({ weatherData }: ShowDisplayDataRight) {
  ...
  return (
    <>
      ...
      <div className="absolute top-[350px] lg:-translate-y-16 lg:-translate-x-32 2xl:translate-y-0 2xl:translate-x-0">
        <div className="absolute top-[550px] mt-16 lg:mt-7 lg:top-16 lg:m-5 lg:translate-x-32 2xl:translate-x-0 ">
