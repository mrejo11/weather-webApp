  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <footer className="fixed bg-gray-800 text-white p-4 text-center translate-y-[2600px] lg:translate-y-0">
          <p>
            © 2025 Weather Forecast. Using Visual Crossing API
            source code{" In "}
            <a
              href="https://github.com/mrejo11/weather-webApp"
              className="fix text-blue-400 hover:underline text-xl ml-2"
            >
